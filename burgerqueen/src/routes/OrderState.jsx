    ...
    <section>
      ...
      <section className="containerOrderState">
        <div className="containerBtnP">
          <ButtonAll
            className="btnOrderRow"
            onClick={() => {
              navigate("/menuOptions");
            }}
          >
            <FontAwesomeIcon
              className="iconArrowOrderState"
        ...
        <div className="containerGridOrderState">
          <div className="pOrderState">
            <div className="pOrderStateSend">
              <p>Enviados</p>
            </div>
            {orderStatusPending.map((order, id) => {
              return (
                <div key={id}>
                  <CardOrderState order={order}></CardOrderState>
                </div>
              );
            })}
          </div>
          ...
          {/* <div className="pOrderState">
            ...
            {orderStatusDelivering.map((order, id) => {
              return (
                <div key={id}>
                  <CardOrderStateDelivering order={order} />
                </div> 
              );
            })}
          </div>  */}
          ...
          <div className="pOrderState">
            ...
            {orderStatusDelivered.map((order, id) => {
              return (
                <div key={id}>
                  <CardOrderStateDelivered order={order} />
                </div>
              );
            })}
          </div>
